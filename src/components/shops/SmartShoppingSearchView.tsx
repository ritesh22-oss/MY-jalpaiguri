    ...
    <div className="min-h-screen bg-[#FAF8F5] dark:bg-[#020617] pb-28 max-w-md mx-auto select-none transition-colors">
      ...
      <header className="sticky top-0 z-30 bg-[#FAF8F5]/95 dark:bg-[#020617]/95 backdrop-blur-md px-4 py-3 border-b border-[#E8E4DA]/60 dark:border-white/10 transition-colors flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <button
            onClick={goBack}
            className="w-10 h-10 rounded-full bg-white dark:bg-[#1E293B] border border-[#E8E4DA] dark:border-white/10 flex items-center justify-center text-[#11241C] dark:text-white shadow-xs hover:bg-[#F3F0E6] dark:hover:bg-[#1F312A] active:scale-95 transition-all cursor-pointer"
          >
        ...
        <div className="bg-[#E8E4DA]/40 dark:bg-white/5 p-1 rounded-2xl flex items-center text-xs font-bold">
          <button
            ...
            className={`flex-1 py-2 rounded-xl text-center transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
              activeTab === 'finder'
                ? 'bg-white dark:bg-[#1E293B] text-[#007AFF] dark:text-blue-400 shadow-xs font-black'
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleSearchItem} className="relative">
              <input
                ...
                className="w-full pl-10 pr-20 py-3 bg-white dark:bg-[#1E293B] border border-[#E8E4DA] dark:border-white/10 rounded-2xl text-xs font-semibold text-[#11241C] dark:text-white placeholder:text-gray-400 focus:outline-none focus:border-[#007AFF] shadow-xs"
              />
                ...
                <div className="space-y-1">
                  {searchHistory.map((term, idx) => (
                    <div
                      ...
                      className="group flex items-center justify-between p-2.5 bg-white dark:bg-[#1E293B] border border-[#E8E4DA] dark:border-white/10 rounded-xl hover:border-blue-300 dark:hover:border-blue-800 transition-all cursor-pointer"
                    >
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar text-[11px] font-bold">
              ...
              {['Rice 5kg', 'Mustard Oil', 'Paracetamol', 'Sandesh', 'Fresh Paneer', 'LED Bulb'].map((chip) => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-white dark:bg-[#1E293B] border border-[#E8E4DA] dark:border-white/10 text-gray-700 dark:text-gray-300 shrink-0 hover:bg-gray-50 cursor-pointer"
                >
                  {chip}
                </button>
              ))}
                ...
                {searchResults.length === 0 ? (
                  ...
                  searchResults.map(({ shop, matchingProducts }) => (
                    <div
                      ...
                      className="bg-white dark:bg-[#1E293B] border border-[#E8E4DA] dark:border-white/10 rounded-2xl p-3.5 shadow-2xs hover:border-[#007AFF] transition-all cursor-pointer space-y-2.5"
                    >
                      ...
                      <div className="pt-2 border-t border-[#F0ECE1] dark:border-white/10 flex justify-end gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-[#dbeafe] dark:bg-blue-900/30 text-[#007AFF] dark:text-blue-300 font-bold text-xs flex items-center gap-1 cursor-pointer"
                        >
            ...
            {matchedShops.length > 0 && (
              <div className="space-y-3">
                ...
                {matchedShops.map((m, idx) => (
                  <div
                    key={idx}
                    className="bg-white dark:bg-[#1E293B] border border-[#E8E4DA] dark:border-white/10 rounded-2xl p-4 shadow-2xs space-y-2.5"
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        <h4 className="font-black text-sm text-[#11241C] dark:text-white">
                      ...
                      <span className="text-xs font-black text-blue-700 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/30 px-2 py-0.5 rounded-lg">
